...
u8 sys_80005360(u8 *str1, u8 *str2, u8 len) {
...
void sys_800057A0(u16 a0)
{
    sys_80005748(a0 >> 8);
    sys_80005748(a0);
}

void sys_800057D0(u32 a0)
{
    sys_800057A0(a0 >> 16);
    sys_800057A0(a0);
}
